...
#SBATCH --job-name CDFMOC_eORCA05_CPU_CRAY
#SBATCH -e CDFMOC_eORCA05_CPU_CRAY.e%j
#SBATCH -o CDFMOC_eORCA05_CPU_CRAY.o%j
#SBATCH --time=2:00:00
...
cd /lus/work/CT1/hmg2840/aalbert/TEST_CDFMOC_GPU/RUN_2026/eORCA05_CPU_CRAY
...
/lus/work/CT1/hmg2840/aalbert/TEST_CDFMOC_GPU/CDFMOC_ldec_CPU_CRAY/cdfmoc -v u.nc -decomp -t t.nc

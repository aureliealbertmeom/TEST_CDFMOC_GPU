...
#SBATCH --job-name CDFMOC_eORCA025_GPU_CRAY
#SBATCH -e CDFMOC_eORCA025_GPU_CRAY.e%j
#SBATCH -o CDFMOC_eORCA025_GPU_CRAY.o%j
#SBATCH --time=2:00:00
...
cd /lus/work/CT1/hmg2840/aalbert/TEST_CDFMOC_GPU/RUN_2026/eORCA025_GPU_CRAY
...
/lus/work/CT1/hmg2840/aalbert/TEST_CDFMOC_GPU/CDFMOC_ldec_GPU_CRAY/cdfmoc -v u.nc  -decomp -t t.nc

...
#SBATCH --job-name CDFMOC_eORCA05_GPU_CRAY
#SBATCH -e CDFMOC_eORCA05_GPU_CRAY.e%j
#SBATCH -o CDFMOC_eORCA05_GPU_CRAY.o%j
#SBATCH --time=2:00:00
...
cd /lus/work/CT1/hmg2840/aalbert/TEST_CDFMOC_GPU/RUN_2026/eORCA05_GPU_CRAY
